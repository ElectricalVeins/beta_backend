...
export class initial1663109237300 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tier"
       (
           ...
           "level"    "public"."tier_level_enum" NOT NULL,
           CONSTRAINT "UQ_ca31b25988ac3848aef318f9b8f" UNIQUE ("name"),
           CONSTRAINT "PK_14d67ceef0dbea040e39e97e7f6" PRIMARY KEY ("id")
       )`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user"
       (
           ...
           "preferredTimezone" character varying,
    ...
    await queryRunner.query(
      `ALTER TABLE "user"
          ADD CONSTRAINT "FK_8dcf78ac4a83d7e2d36abecb8f3" FOREIGN KEY ("tierId") REFERENCES "tier" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "user"
        DROP CONSTRAINT "FK_8dcf78ac4a83d7e2d36abecb8f3"`);
    await queryRunner.query(`ALTER TABLE "user"
